...
// Clear screen and print the board and the relevant message
...
// Print the player's turn before getting input
...
// Check if the input is within the board
...
void Chess::doTurn() {
    ...
    switch (m_codeResponse) {
        case 11:
            ...
            break;
        case 12:
            m_msg = "The piece in the source is a piece of your opponent\n";
            break;
        case 13:
